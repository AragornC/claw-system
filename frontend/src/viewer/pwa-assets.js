...
export const SERVICE_WORKER_JS = `const CACHE_NAME = 'perp-report-pwa-v9';
const PRECACHE = [
  './',
  './index.html',
  './manifest.json',
...
export const APP_ICON_MASKABLE_SVG = `<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
