...
export THUNDERCLAW_FORCE_CAPABILITY_PROFILE="${THUNDERCLAW_FORCE_CAPABILITY_PROFILE:-1}"
export THUNDERCLAW_LEGACY_CHAT_INTENTS="${THUNDERCLAW_LEGACY_CHAT_INTENTS:-0}"
export THUNDERCLAW_TRADING_PLUGIN_ENABLED="${THUNDERCLAW_TRADING_PLUGIN_ENABLED:-1}"
if [[ "${THUNDERCLAW_FORCE_CAPABILITY_PROFILE}" == "0" ]]; then
  ...
  export THUNDERCLAW_CHAT_RUNTIME_MODE="openclaw-native"
  export THUNDERCLAW_TOOL_ADAPTER="mcp"
  export THUNDERCLAW_MCP_BRIDGE_ENABLED="1"
  export THUNDERCLAW_MCP_BRIDGE_AUTOSTART="1"
  echo "[init] capability profile: openclaw-native + mcp bridge (forced)"
fi
